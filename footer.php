...
<div id="footer-new">
            ...
            <div class="row">
                <div class="sixteen columns">
                    ...
                    <div class="footer-new-rows-container">
                        ...
                        <?php $logo = Kirki::get_option('templ', 'pp_footer_logo_upload', '' ); 
                        if($logo){ ?>
                        <!-- Left Side -->
                        ...
                        <div class="footer-new-rows-right">
                            <?php $stats_counter = Kirki::get_option('templ','footer_stat_counters'); 
    ...
    <div class="footer-new-middle-section">
        <div class="container">
    		...
    		<?php 
    		$footer_layout = Kirki::get_option( 'templ', 'pp_new_footer_widgets' ); 
            ...
            <div class="row">
                <div class="sixteen columns">
                    <div class="footer-new-bottom-inner">
                        <div class="footer-new-bottom-left"><?php $copyrights = Kirki::get_option( 'templ', 'pp_copyrights' ); 
                        ...
                        <?php 
                        $footericons = Kirki::get_option('templ', 'pp_footericons', array() );
...
<?php if( is_page_template('template-home-resumes.php') && Kirki::get_option('templ','pp_resume_home_typed_status') == 'enable') { 
    $typed =  Kirki::get_option('templ','pp_resume_home_typed_text'); 
