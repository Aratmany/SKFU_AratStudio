...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20201025_skfu_b5d0afed7830ebbc1886_20201025053605_archive.zip';
    const ARCHIVE_SIZE       = '43941549';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'b5d0afe-25053605';
    const VERSION            = '3.8.7.1';

    const MINIMUM_PHP_VERSION = '7.3.17';
        ...
        <html>
            ...
            <body>
                <div>
                    <h1>Ошибка</h1>
                    <p>
                        This server is running PHP: <b>7.2.17</b>. <i>A minimum of <b>PHP <?php echo self::MINIMUM_PHP_VERSION; ?></b> is required</i>.<br><br>
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.7.1==');
        $this->log('----------------------------------------------------');
