...
<div id="related-job-container">
    ...
    <h3 class="margin-bottom-5 margin-top-55"><?php esc_html_e('Похожие вакансии','templ'); ?></h3>
    ...
    <div id="related-job-spotlight" class="related-job-spotlight-car showbiz-container" data-visible="[2,2,1,1]">
                  ...
                  $wp_query->the_post(); 
                    ...
                    $id = get_the_id(); ?>
                        ...
                        <div class="job-spotlight">
                            <?php $job_meta = Kirki::get_option( 'templ','pp_meta_job_list',array('company','location','rate','salary') ); ?>
                ...
                <?php endforeach; endif; ?>
                            ...
                            <a href="<?php the_permalink(); ?>" class="button"><?php esc_html_e('Откликнуться','templ') ?></a>
                        </div>
